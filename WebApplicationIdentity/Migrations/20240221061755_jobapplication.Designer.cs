...
namespace WebApplicationIdentity.Migrations
{
    ...
    [Migration("20240221061755_jobapplication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplicationIdentity.Models.Applyforjob", b =>
                {
            ...
            modelBuilder.Entity("WebApplicationIdentity.Models.JobApplication", b =>
                {
                    b.Property<string>("ApplicationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("WebApplicationIdentity.Models.Applyforjob", b =>
                {
                    ...
                    b.HasOne("WebApplicationIdentity.Models.AddJobs", "Job")
                        .WithMany("Applyforjobs")
            ...
            modelBuilder.Entity("WebApplicationIdentity.Models.JobApplication", b =>
                {
                    ...
                    b.HasOne("WebApplicationIdentity.Models.AddJobs", "AddJobs")
                        .WithMany()
                        .HasForeignKey("Job_Id");
